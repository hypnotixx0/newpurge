...
window.showKeyPopup = function(category) {
    ...
    console.log('✅ Key popup elements found, showing popup');
    ...
    try {
        ...
        const hideKeyPopup = () => {
            ...
            if (submitKeyBtn) {
                ...
                submitKeyBtn.classList.remove('loading');
        ...
        const validateKey = () => {
            ...
            submitKeyBtn.innerHTML = '<i class="fas fa-key"></i> Accessing...';
            submitKeyBtn.classList.add('loading');
        ...
        console.log('🔑 Premium keys: CHARLESISPOOR, UNHIIN, SOSAPARTY (All access)');
    } catch (e) {
